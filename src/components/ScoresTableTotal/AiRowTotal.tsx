...
import {AiWithScoresTotal, useAiWithScoresTotal} from "../../hooks/useAiWithScoresTotal";
...
export const AiRowTotal  = (props: Props) => {
    ...
    return isSmallScreen ? (
        ...
        <>
            ...
            <TableRow key={aiWithScore.id} style={{ backgroundColor: CUSTOM_COLORS.grey}}>
                <TableCell
                    align="center"
                ...
                <TableCell align="center" style={{ width: "8%" }}>
                    <img
                        ...
                        height={30}
                        alt="United States"
                        src={getCountryFlagUrlById(props.countries, aiWithScore.winnerPrediction)}
                    />
                </TableCell>
                <TableCell align="center" style={{ width: "8%" }}>
...
const RowAi = ({ countries, data }: { countries: Country[]; data: AiWithScoresTotal}) => {
